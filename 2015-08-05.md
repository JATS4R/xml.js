...
- Every day:  do [Checklists](/Checklists) stuff
* Do a status report for Mark every day.


* Do an updated survey of tasks I still owe Sergey.
* JATS4R - Get everything ready for the telecon this week and Balisage next week
* Work on Confluence some today: open source ("interim github guidelines"), python and
  django
* Get my laptop set up for remote access
* Data citations / NLM style



# JATS4R elements / recommendations

## Data citations

* [Issue #30](https://github.com/JATS4R/elements/issues/30)
...
### How to integrate my utility and xmllint
